...
/// <summary>
/// Mock veri deposu. DB bağlandığında bu sınıf yerine gerçek repository'ler kullanılacak.
/// </summary>
public class MockDataStore
{
    ...
    private static readonly Lazy<MockDataStore> Instance = new(() => new MockDataStore());

    public static MockDataStore Current => Instance.Value;
    ...
    private void Seed()
    {
        ...
        ResourceSystems.AddRange(new[] { sysBitbucket, sysMail, sysVpn, sysOffice, sysErp, sysTestEnv });
        ...
        // Personel yetkileri (rol bazlı + bir exception örneği)
        ...
        // Exception: dev1'e ERP Read (rolünde yok)
        PersonnelAccesses.Add(new PersonnelAccess
        {
            Id = Guid.NewGuid(),
            PersonnelId = dev1.Id,
        ...
        ApprovalSteps.Add(new ApprovalStep { Id = Guid.NewGuid(), AccessRequestId = req1.Id, StepName = "Manager", ApprovedBy = manager.Id, ApprovedAt = now.AddDays(-4), Approved = true, Order = 1 });
        ApprovalSteps.Add(new ApprovalStep { Id = Guid.NewGuid(), AccessRequestId = req1.Id, StepName = "IT", ApprovedBy = manager.Id, ApprovedAt = now.AddDays(-3), Approved = true, Order = 2 });
        ...
        ApprovalSteps.Add(new ApprovalStep { Id = Guid.NewGuid(), AccessRequestId = reqPending.Id, StepName = "Manager", ApprovedBy = null, ApprovedAt = null, Approved = null, Order = 1 });
